...
//	      
		...
		bSet.setBackgroundResource(android.R.drawable.btn_default);
		bVerify.setBackgroundResource(android.R.drawable.btn_default);
	      ...
	      for(int i=0;i<6;i++)
	      {
			...
			//	Toast.makeText(getApplicationContext(), color, 1).show();
				...
				s++;
					...
					Toast.makeText(getApplicationContext(), "Max 6 Color codes", Toast.LENGTH_SHORT).show();
