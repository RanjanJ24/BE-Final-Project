...
//    }
	@Override
	   protected void onCreate(Bundle savedInstanceState) {
		  ...
		  bL.setBackgroundResource(android.R.drawable.btn_default);
		  bR.setBackgroundResource(android.R.drawable.btn_default);
		  bRsa.setBackgroundResource(android.R.drawable.btn_default);
		  bColor.setBackgroundResource(android.R.drawable.btn_default);
		  bK1.setBackgroundResource(android.R.drawable.btn_default);
		  bKekey.setBackgroundResource(android.R.drawable.btn_default);
		  bUploadCloud.setBackgroundResource(android.R.drawable.btn_default);
		  bSetAP.setBackgroundResource(android.R.drawable.btn_default);
	      ...
	      bRsa.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(), "Public Key ["+E+","+N+"]", Toast.LENGTH_SHORT).show();
				
				Toast.makeText(getApplicationContext(),  "Private Key ["+D+","+N+"]", Toast.LENGTH_SHORT).show();
